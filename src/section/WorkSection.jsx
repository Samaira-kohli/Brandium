    ...
    return (
        <section>
            <div ref={mainRef} className='[perspective:900px] w-full flex flex-col justify-center items-center lg:gap-3 gap-8 py-25 px-3 lg:h-130 h-90'>
                <h5 ref={headingRef} className='text-center text-4xl md:text-6xl lg:text-8xl font-semibold lg:leading-none h-[70%] tracking-tighter md:w-[80%]'>
                    Showcasing crafted experiences that connect
                </h5>

                <p ref={paraRef} className='lg:w-[43%] md:w-2/3 leading-tight text-[1rem] lg:text-[1.4rem] -m-5 lg:m-0 text-center'>
                    See how we partner with visionary teams to build brands that
                    stand out and push the boundaries of innovation.
                </p>
            </div>
        </section>
    )
